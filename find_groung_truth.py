...
import csv
import random
path_to_average = "C:/Users/Allen/pair_trading DL/2015/averageprice/"
ext_of_average = "_averagePrice_min.csv"
path_to_minprice = "C:/Users/Allen/pair_trading DL/2015/minprice/"
ext_of_minprice = "_min_stock.csv"
path_to_compare = "C:/Users/Allen/pair_trading DL/newcompare2015/"
...
for date in sorted(datelist):
   ...
   # print(gt[0][0])
    ...
    #print("====================================================================================")
        flag = os.path.isfile('C:/Users/Allen/pair_trading DL/gt2015/'+str(date)+'_ground truth.csv')
