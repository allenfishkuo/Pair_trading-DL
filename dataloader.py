...
path_to_2015half = "C:/Users/Allen/pair_trading DL/2015_halfmin/"
path_to_2016half = "C:/Users/Allen/pair_trading DL/2016_halfmin/"
...
path_to_2015compare = "C:/Users/Allen/pair_trading DL/newcompare2015/" 
path_to_2016compare = "C:/Users/Allen/pair_trading DL/newcompare2016/" 
path_to_2017compare = "C:/Users/Allen/pair_trading DL/newcompare2017/" 
...
path_to_choose2015 = "C:/Users/Allen/pair_trading DL/gt2015/"
path_to_choose2016 = "C:/Users/Allen/pair_trading DL/gt2016/"
path_to_choose2017 = "C:/Users/Allen/pair_trading DL/gt2017/"
path_to_choose2018 = "C:/Users/Allen/pair_trading DL/gt2018/"
    ...
    #        tickdata = pd.read_csv(path_to_minprice+date+ext_of_minprice)
            ...
            for ch in range(1):
                for pair in range(len(table)):
                    ...
                    elif count > 129 and count <=168:  #9-10月                  
                        number = gt[pair][0]
                        for i in range(25): #幾個action
                            if number == i  :
                                test_data.append(new_spread)
...
def test_data():
    ...
    #print(datelist)
    count = 0
    for date in sorted(datelist[168:]): #10月開始
        count +=1
        table = pd.read_csv(path_to_2018compare+date+ext_of_compare)
        #mindata = pd.read_csv(path_to_average+date+ext_of_average)
        halfmin = pd.read_csv(path_to_2018half+date+ext_of_half)
